...
public class GodIndex extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            Logger.getLogger(GodIndex.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public float calcularNota(Document user_answer, Document respuestas) {
        ...
        System.out.println(respuestas.getString("q_01"));
        System.out.println(respuestas.getString("q_02"));
        System.out.println(user_answer.getString("q_01"));
        System.out.println(user_answer.getString("q_02"));
